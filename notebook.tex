...
{\color{incolor}In [{\color{incolor}288}]:} \PY{c+c1}{\PYZsh{}Importing the pandas library, responsable to manipulate and tranform the data contained on csv files on dataframes}
...
também carregando uma parte dos dados para verificar seu conteúdo.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}289}]:} \PY{n}{passengers}  \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{titanic\PYZhy{}data\PYZhy{}6.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{passengers}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}289}]:}    PassengerId  Survived  Pclass  \textbackslash{}
          0            1         0       3   
          1            2         1       1   
          2            3         1       3   
          3            4         1       1   
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}290}]:} \PY{n}{passengers}\PY{o}{.}\PY{n}{describe}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}290}]:}        PassengerId    Survived      Pclass         Age       SibSp  \textbackslash{}
...
687 e 2 dados nulos respectivamentos.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}291}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{passengers}\PY{o}{.}\PY{n}{isnull}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}\PY{p}{)}
...
possui
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}292}]:} \PY{n}{passengers}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Title}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{passengers}\PY{o}{.}\PY{n}{Name}\PY{o}{.}\PY{n}{str}\PY{o}{.}\PY{n}{extract}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{([A\PYZhy{}Za\PYZhy{}z]+)}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{expand}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
...
dropar essa coluna.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}293}]:} \PY{n}{passengers}\PY{o}{.}\PY{n}{Embarked}\PY{o}{.}\PY{n}{fillna}\PY{p}{(}\PY{n}{passengers}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Embarked}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{mode}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}293}]:} PassengerId    0
          Survived       0
          Pclass         0
          Name           0
          Sex            0
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}294}]:} \PY{n}{passengers}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilySize}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}  \PY{o}{=} \PY{n}{passengers}\PY{o}{.}\PY{n}{SibSp} \PY{o}{+} \PY{n}{passengers}\PY{o}{.}\PY{n}{Parch}\PY{o}{+} \PY{l+m+mi}{1}
...
variáveis
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}295}]:} \PY{k}{def} \PY{n+nf}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{ax} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{countplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{independent}\PY{p}{,} \PY{n}{hue}\PY{o}{=}\PY{n}{dependent}\PY{p}{,}\PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{)}
              \PY{n}{ax}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Not Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
              \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{n}{independent}\PY{p}{)}
          ...
          \PY{k}{def} \PY{n+nf}{heatmap}\PY{p}{(}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              ...
              \PY{n}{ax}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Heat Map}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
...
estarão em nossas futuras vizualizações.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}296}]:} \PY{n}{heatmap}\PY{p}{(}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
...
sobrevivência
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}297}]:} \PY{c+c1}{\PYZsh{}Setting aesthetics of seaborn  graphic and setting our dependent variable}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}298}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Pclass}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}299}]:} \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
...
A tendência de sobrevivência é maior nas mulheres do que nos homens.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}300}]:} \PY{n}{independent}   \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Sex}\PY{l+s+s2}{\PYZdq{}}
...
sozinha.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}301}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilyGroup}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
...
mais baratas(Cheap).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}302}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FareGroup}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
...
é de não sobrevivência
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}303}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{AgeGroup}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
