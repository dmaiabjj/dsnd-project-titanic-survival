...
{\color{incolor}In [{\color{incolor}391}]:} \PY{c+c1}{\PYZsh{}Importing the pandas library, responsable to manipulate and tranform the data contained on csv files on dataframes}
...
também carregando uma parte dos dados para verificar seu conteúdo.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}392}]:} \PY{n}{passengers}  \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{titanic\PYZhy{}data\PYZhy{}6.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{passengers}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}392}]:}    PassengerId  Survived  Pclass  \textbackslash{}
          0            1         0       3   
          1            2         1       1   
          2            3         1       3   
          3            4         1       1   
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}393}]:} \PY{n}{passengers}\PY{o}{.}\PY{n}{describe}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}393}]:}        PassengerId    Survived      Pclass         Age       SibSp  \textbackslash{}
...
687 e 2 dados nulos respectivamentos.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}394}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{passengers}\PY{o}{.}\PY{n}{isnull}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}\PY{p}{)}
...
possui
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}395}]:} \PY{n}{passengers}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Title}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{passengers}\PY{o}{.}\PY{n}{Name}\PY{o}{.}\PY{n}{str}\PY{o}{.}\PY{n}{extract}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{([A\PYZhy{}Za\PYZhy{}z]+)}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{expand}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}
...
dropar essa coluna.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}396}]:} \PY{n}{passengers}\PY{o}{.}\PY{n}{Embarked}\PY{o}{.}\PY{n}{fillna}\PY{p}{(}\PY{n}{passengers}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Embarked}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{o}{.}\PY{n}{mode}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,}\PY{n}{inplace}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}396}]:} PassengerId    0
          Survived       0
          Pclass         0
          Name           0
          Sex            0
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}397}]:} \PY{n}{passengers}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilySize}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}  \PY{o}{=} \PY{n}{passengers}\PY{o}{.}\PY{n}{SibSp} \PY{o}{+} \PY{n}{passengers}\PY{o}{.}\PY{n}{Parch}\PY{o}{+} \PY{l+m+mi}{1}
          ...
          \PY{n}{passengers}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilyGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}    \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{cut}\PY{p}{(}\PY{n}{passengers}\PY{o}{.}\PY{n}{FamilySize}\PY{p}{,}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{n}{passengers}\PY{o}{.}\PY{n}{FamilySize}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{p}{]}\PY{p}{,}\PY{n}{labels}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Single}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Normal}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Large}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
Primeiro construímos uma função que passado o nome da váriavel
dependente e independente, ela gera um gráfico da relação entre as 2
variáveis

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}398}]:} \PY{k}{def} \PY{n+nf}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{sns}\PY{o}{.}\PY{n}{countplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{independent}\PY{p}{,} \PY{n}{hue}\PY{o}{=}\PY{n}{dependent}\PY{p}{,}\PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Number of people}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x Number of people}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{n}{dependent}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Not Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
             
          \PY{k}{def} \PY{n+nf}{heatmap}\PY{p}{(}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{corr}  \PY{o}{=} \PY{n}{data\PYZus{}frame}\PY{o}{.}\PY{n}{corr}\PY{p}{(}\PY{p}{)}
              \PY{n}{sns}\PY{o}{.}\PY{n}{heatmap}\PY{p}{(}\PY{n}{corr}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Heat Map}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
              
          \PY{k}{def} \PY{n+nf}{join}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{sns}\PY{o}{.}\PY{n}{jointplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{independent}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{dependent}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{,}\PY{n}{kind}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{reg}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{dependent}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{n}{dependent}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{sns}\PY{o}{.}\PY{n}{violinplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{independent}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{dependent}\PY{p}{,}\PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{,}\PY{n}{split}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,}\PY{n}{size}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,} \PY{n}{aspect}\PY{o}{=}\PY{o}{.}\PY{l+m+mi}{7}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{dependent}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{n}{dependent}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{sns}\PY{o}{.}\PY{n}{pointplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{independent}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{dependent}\PY{p}{,}\PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{,} \PY{n}{dodge}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{dependent}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{n}{dependent}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{kde}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{facet} \PY{o}{=} \PY{n}{sns}\PY{o}{.}\PY{n}{FacetGrid}\PY{p}{(}\PY{n}{data\PYZus{}frame}\PY{p}{,} \PY{n}{hue}\PY{o}{=}\PY{n}{dependent}\PY{p}{,}\PY{n}{aspect}\PY{o}{=}\PY{l+m+mf}{1.2}\PY{p}{,}\PY{n}{size}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}
              \PY{n}{facet}\PY{o}{.}\PY{n}{map}\PY{p}{(}\PY{n}{sns}\PY{o}{.}\PY{n}{kdeplot}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{shade}\PY{o}{=} \PY{k+kc}{True}\PY{p}{)}
              \PY{n}{facet}\PY{o}{.}\PY{n}{set}\PY{p}{(}\PY{n}{xlim}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{data\PYZus{}frame}\PY{p}{[}\PY{n}{independent}\PY{p}{]}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{dependent}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{n}{dependent}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Not Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
              
          \PY{k}{def} \PY{n+nf}{swarm}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{hue}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{sns}\PY{o}{.}\PY{n}{swarmplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{y}\PY{p}{,} \PY{n}{hue}\PY{o}{=}\PY{n}{hue}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{;}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{y}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{hue}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Not Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
          
          \PY{k}{def} \PY{n+nf}{box}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{hue}\PY{p}{,}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{:}
              \PY{n}{sns}\PY{o}{.}\PY{n}{boxplot}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{n}{y}\PY{p}{,} \PY{n}{hue}\PY{o}{=}\PY{n}{hue}\PY{p}{,} \PY{n}{data}\PY{o}{=}\PY{n}{data\PYZus{}frame}\PY{p}{)}\PY{p}{;}
              \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{n}{y}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{ x }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{n}{hue}\PY{p}{)}\PY{o}{.}\PY{n}{upper}\PY{p}{(}\PY{p}{)}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Not Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
              \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
          ...
          \PY{k}{def} \PY{n+nf}{graph}\PY{p}{(}\PY{n}{graph}\PY{p}{)}\PY{p}{:}
              \PY{n}{switcher} \PY{o}{=} \PY{p}{\PYZob{}}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{bar}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{bar}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{heatmap}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{heatmap}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{join}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{join}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{violin}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{violin}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{point}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{point}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{kde}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{kde}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{swarm}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{swarm}\PY{p}{,}
                      \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{box}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:} \PY{n}{box}
                  \PY{p}{\PYZcb{}}
              \PY{c+c1}{\PYZsh{} Get the function from switcher dictionary}
              \PY{k}{return} \PY{n}{switcher}\PY{o}{.}\PY{n}{get}\PY{p}{(}\PY{n}{graph}\PY{p}{)}
          
          \PY{n}{bar}     \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{bar}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{heatmap} \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{heatmap}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{join}    \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{join}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{violin}  \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{violin}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{point}   \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{point}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{kde}     \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{kde}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{swarm}   \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{swarm}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
          \PY{n}{box}     \PY{o}{=} \PY{n}{graph}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{box}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}


    \subsection{9.1 HeatMap}\label{heatmap}

O gráfico de heatmap é importante para verificarmos o quão
correlacionadas estão as variáveis uma das outras, assim teremos uma
noção de quais são importantes para nossa análise e consequentemente
estarão em nossas futuras vizualizações.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}399}]:} \PY{n}{heatmap}\PY{p}{(}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
    ...
    \subsection{9.1 Gráficos Pclass x
Survived}\label{gruxe1ficos-pclass-x-survived}

Nos gráficos vemos que a 1º classe foi a única com taxa de sobrevivência
...
sobrevivência
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}400}]:} \PY{c+c1}{\PYZsh{}Setting aesthetics of seaborn  graphic and setting our dependent variable}
          \PY{n}{sns}\PY{o}{.}\PY{n}{set}\PY{p}{(}\PY{p}{)}
          \PY{n}{dependent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}401}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Pclass}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}402}]:} \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{join}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{kde}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
    ...
    \subsection{9.2 Gráficos Sex x
Survived}\label{gruxe1ficos-sex-x-survived}

Nos gráficos vemos que a taxa de sobrevivência de mulheres foi maior do
...
A tendência de sobrevivência é maior nas mulheres do que nos homens.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}403}]:} \PY{n}{independent}   \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Sex}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
    ...
    \subsection{9.3 Gráficos FamilyGroup x Survived e FamilySize x
Survived}\label{gruxe1ficos-familygroup-x-survived-e-familysize-x-survived}

Temos uma categorização da quantidade de familiares: * Single - (1) *
Normal - (2 - 4) * Large - (5 - 11)

Nos gráficos vemos famílias de tamanho normal, de 2 até 4 integrantes
foi a única com taxa de sobrevivência maior do que a de não
sobrevivência comparada com as outras categorias.
...
sozinha.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}404}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilyGroup}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilySize}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{kde}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{join}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{swarm}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilyGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{dependent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{box}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FamilyGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{dependent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
...
mais baratas(Cheap).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}405}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FareGroup}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Fare}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{join}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{kde}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{swarm}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FareGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{dependent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{box}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{FareGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{dependent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
...
é de não sobrevivência
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}406}]:} \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{AgeGroup}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{bar}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{point}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{violin}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{independent} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Age}\PY{l+s+s2}{\PYZdq{}}
          \PY{n}{join}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{kde}\PY{p}{(}\PY{n}{dependent}\PY{p}{,}\PY{n}{independent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{swarm}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{AgeGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{dependent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
          \PY{n}{box}\PY{p}{(}\PY{n}{independent}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{AgeGroup}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{dependent}\PY{p}{,}\PY{n}{passengers}\PY{p}{)}
\end{Verbatim}
